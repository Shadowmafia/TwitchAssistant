...
namespace TwitchBot.CommandsSystem
{
    ...
    //        {
    //            userCommands.Add(new UserCommand() {Id = command.Id, Name = command.Name, Message = command.Message,IsEnabled = command .IsEnabled,Whisp = command.Whisp,Description = command.Description});
    //        }

    //        GlobalObjects.UsersRepository.AddOrUpdateCommands(userCommands);
    //        GlobalObjects.UsersRepository.SaveChanges();
    //    }
    ...
    //        };
    //        List<UserCommand> userCommands = GlobalObjects.UsersRepository.GetCommands();
    ...
    //            {
    //                var tmpUser = GlobalObjects.UsersRepository.GetUsers().First(user1 => user1.Username == user.Username);
    //                MinRangCheck(tmpUser);
    //                bool coinSystemSuccess = false;

    //                if (ConfigSet.Config.PlayerConfig.IsUsingCoinSystem)
    //                {
    //                    if (CoinSystem.CoinSystem.GetInstance().SubtractCoins(tmpUser, ConfigSet.Config.PlayerConfig.SongPrice))
    //                    {
    ...
    //                {
    //                    playerResponse = GlobalObjects.Player.AddChatSong(body, user.Username);
    //                    if (playerResponse == "")
    //                    {
    //                        playerResponse = "Song not found or invalid link =(";
    //                        if (ConfigSet.Config.PlayerConfig.IsUsingCoinSystem)
    //                        {
    //                            CoinSystem.CoinSystem.GetInstance().AddCoins(tmpUser, ConfigSet.Config.PlayerConfig.SongPrice);
    //                        }
    //                    }
    //                }
    //            }
    ...
    //                if (ConfigSet.Config.PlayerConfig.IsUsingCoinSystem)
    //                {
    //                    if (CoinSystem.CoinSystem.GetInstance().SubtractCoins(tmpUser, ConfigSet.Config.PlayerConfig.FirstSongPrice))
    //                    {
    //                        coinSystemSuccess = true;
    //                    }
    //                    else
    ...
    //                if (coinSystemSuccess)
    //                {
    //                    playerResponse = GlobalObjects.Player.AddFirstChatSong(body, user.Username);
    //                    if (playerResponse == "")
    //                    {
    //                        playerResponse = "Song not found or invalid link =(";
    //                        if (ConfigSet.Config.PlayerConfig.IsUsingCoinSystem)
    ...
    //                if (CoinSystem.CoinSystem.GetInstance().SubtractCoins(tmpUser, ConfigSet.Config.PlayerConfig.SkipSongPrice))
    //                {
    //                    coinSystemSuccess = true;
    //                }
    //                else
    ...
    //            if (coinSystemSuccess)
    //            {
    //                responseMessage = $"skipped song! Title : '{GlobalObjects.Player.CurrentSong.Title}'";
    //                GlobalObjects.Player.PlayNextSong();
    //            }
    //        }
    //        catch (Exception e)
    //        {
    ...
    //    {
    //        string responseMessage = GlobalObjects.Player.GetCurrentSongInfo();
    //        CommandMessage(user.Username, responseMessage, command);
    //    }
    ...
    //        try
    //        {
    //            var length = GlobalObjects.Player.ChatPlayList.Count - GlobalObjects.Player.LastChatSong.Index;
    ...
    //    {
    //        string responseMessage = GlobalObjects.Player.GetStreamerPlaylistInfo();
    //        if (responseMessage == "")
    //        {
    ...
    //    {
    //        string responseMessage = GlobalObjects.Player.GetChatPlaylistInfo();
    //        if (responseMessage == "")
    //        {
    ...
    //        try
    //        {
    //            var tmpUser = GlobalObjects.UsersRepository.GetUsers().First(user1 => user1.Username == body);
    ...
    //    {
    //        string responseMessage = "";
    //        if (GlobalObjects.IsStreamOnline)
    //        {
    //            responseMessage = $"Stream up time :  {GlobalObjects.StreamUpTime} .";
    //        }
    //        else
    //        {
    ...
    //        if (command.Whisp)
    //        {
    //            WhispMessage(user, message);               
    //        }
    //    }
    //    private static void SendMessage(string message)
    //    {
    //        TwitchBotGlobalObjects.Bot.SendMessage(message);
    //    }
    //    private static void WhispMessage(string user, string message)
    //    {
