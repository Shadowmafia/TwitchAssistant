...
using TwitchAssistant.TwitchBot.CoinSystem;
using TwitchAssistant.TwitchBot.CommandsSystem;
using TwitchAssistant.TwitchBot.TimerSystem;
...
namespace TwitchAssistant.TwitchBot
{
    public class Bot
    {
        ...
        {
            GlobalObjects.Player.OnSongChanged += ChangedSongNotify;
        ...
        private static void ChangedSongNotify(object sender, Song e)
        {
            ...
            {
                TwitchBotGlobalObjects.Bot.SendMessage(GlobalObjects.Player.GetCurrentSongInfo());
            }
        }
